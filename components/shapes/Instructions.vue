  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 336 330">
    ...
    <g fill="none" fill-rule="evenodd">
      ...
      <g fill="#B1B4C5">
        ...
        <text font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="6" font-style="condensed" font-weight="bold" transform="translate(124 131)">
        ...
        <text font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="6" font-style="condensed" font-weight="bold" transform="rotate(40 -161.263 250.617)">
        ...
        <text font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="6" font-style="condensed" font-weight="bold" transform="rotate(-40 373.263 -90.07)">
          <tspan x="36" y="6">BEATS</tspan>
        </text>
        <g>
          ...
          <text font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="6" font-style="condensed" font-weight="bold" transform="rotate(-110 174.766 34.934)">
            <tspan x="36" y="6">BEATS</tspan>
          </text>
        </g>
        <g>
          ...
          <text font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="6" font-style="condensed" font-weight="bold" transform="rotate(110 37.234 121.76)">
            <tspan x="36" y="6">BEATS</tspan>
          </text>
        </g>
      </g>
      <text fill="#B1B4C5" font-family="BarlowSemiCondensed-Bold, Barlow Semi Condensed" font-size="11" font-style="condensed" font-weight="bold">
